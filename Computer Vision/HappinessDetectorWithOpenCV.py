    ...
    for x, y, w, h in faces:
        ...
        for ex, ey, ew, eh in eyes:
            cv2.rectangle(roi_color, (ex, ey), (ex + ew, ey + eh), (0, 255, 0),
                          2)  # ROI Color Prints into Frame Aswell, as it works with the subsequence of frame
            
        #Within inner face and after eyes are detected, detect a smile w/ multiScale function given by cascade
        smiles = smile_cascade.detectMultiScale(roi_gray, 1.7, 22) #Use smile cascade to detect smiles    
